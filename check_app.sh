...
flake8 ./falken_quotes/main.py ./falken_quotes/* --count --select=E9,F63,F7,F82 --show-source --statistics
# exit-zero treats all errors as warnings. The GitHub editor is 127 chars wide
echo "***** Linter: Checking Python syntax patterns *****"
flake8 main.py ./falken_quotes/* --count --exit-zero --max-complexity=10 --max-line-length=127 --statistics
